 ...
 * local func decl
 * */
//static int IsFileExist(const char*);
static int load_ini_file(const char*, char*,int*);
static int newline(char);
static int end_of_string(char);
static int left_barce(char);
static int isright_brace(char);
static int parse_file(const char*,const char*,const char*,int*,int*,int*,int*,int*,int*);
            ...
            const char *file)
{
	...
	{
		int cpcount = value_e -value_s; // wsf
